...
if __name__ == "__main__":
    ...
    CKPT_PATH = os.path.join(os.getcwd(), r"ckpt_012-vloss_0.2087_vf1_0.9516.ckpt")
    ...
    images_dir = glob(os.path.join(os.getcwd(), "samples") + os.sep + "*.jpeg")
    ...
    iface = gr.Interface(
        ...
        title="Oral Cancer Detection By Ali Muhannad Ahmed",
